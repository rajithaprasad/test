...
const BrokerInfoSection0 = ({ formData, updateFormData, onPrevious }) => {
          ...
          <div className="relative">
            ...
            <div className="floating-input">
              <input
                ...
                onChange={(e) =>
                  updateFormData({ brokerFirstName: e.target.value })
                }
                placeholder=" "
          ...
          <div className="relative">
            ...
            <div className="floating-input">
              <input
                ...
                onChange={(e) =>
                  updateFormData({ brokerLastName: e.target.value })
                }
                placeholder=" "
                className="w-full p-4 border-2 border-gray-200 rounded-xl bg-white/50 backdrop-blur-sm focus:border-emerald-500 focus:bg-white focus:outline-none transition-all duration-300 text-lg"
              />
              <label
                htmlFor="brokerLastName"
                className="absolute left-4 top-4 text-gray-500 transition-all duration-300 pointer-events-none bg-white px-1 -mt-2 text-sm"
              >
                Last Name
              </label>
          ...
          <div className="relative">
            ...
            <div className="floating-input">
              <input
                ...
                onChange={(e) =>
                  updateFormData({ brokerEmail: e.target.value })
                }
                placeholder=" "
                className="w-full p-4 border-2 border-gray-200 rounded-xl bg-white/50 backdrop-blur-sm focus:border-emerald-500 focus:bg-white focus:outline-none transition-all duration-300 text-lg"
              />
          ...
          <div className="relative">
            ...
            <div className="floating-input">
              <input
                ...
                onChange={(e) =>
                  updateFormData({ brokerPhoneNumber: e.target.value })
                }
                placeholder=" "
                className="w-full p-4 border-2 border-gray-200 rounded-xl bg-white/50 backdrop-blur-sm focus:border-emerald-500 focus:bg-white focus:outline-none transition-all duration-300 text-lg"
              />
              <label
                htmlFor="brokerPhoneNumber"
                className="absolute left-4 top-4 text-gray-500 transition-all duration-300 pointer-events-none bg-white px-1 -mt-2 text-sm"
              >
                Phone Number
              </label>
...
export default BrokerInfoSection0;
