...
interface LoanDetailsSection4Props {
  formData: FormData;
...
const LoanDetailsSection4 = ({ formData, updateFormData, onNext, onPrevious }: LoanDetailsSection4Props) => {
    ...
    <form onSubmit={handleSubmit} className="space-y-8 animate-fade-in">
     <ProgressIndicator
      ...
      <div className="text-center">
        ...
        <p className="text-lg text-gray-600">Section 4: Fix & Flip - Acquisition</p>
      </div>

      <div className="bg-blue-50 rounded-xl p-6 border border-blue-100">
        <h3 className="text-xl font-semibold text-blue-800 mb-6">Loan Details - Section 4</h3>
...
export default LoanDetailsSection4;
