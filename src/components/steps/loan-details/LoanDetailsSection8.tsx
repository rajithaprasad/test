...
interface LoanDetailsSection8Props {
  formData: FormData;
...
const LoanDetailsSection8 = ({ formData, updateFormData, onNext, onPrevious }: LoanDetailsSection8Props) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-8 animate-fade-in">
      ...
      <div className="text-center">
        ...
        <p className="text-lg text-gray-600">Section 8: Bridge - Refinance</p>
      </div>

      <div className="bg-blue-50 rounded-xl p-6 border border-blue-100">
        <h3 className="text-xl font-semibold text-blue-800 mb-6">Loan Details - Section 8</h3>
...
export default LoanDetailsSection8;
