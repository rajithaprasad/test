...
interface ScenarioSpecificInfo5Props {
  formData: FormData;
...
const ScenarioSpecificInfo5 = ({ formData, updateFormData, onNext, onPrevious }: ScenarioSpecificInfo5Props) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-8 animate-fade-in">
      ...
      <div className="text-center">
        ...
        <p className="text-lg text-gray-600">Section 5</p>
      </div>

      <div className="bg-blue-50 rounded-xl p-6 border border-blue-100">
        <h3 className="text-xl font-semibold text-blue-800 mb-6">Section 5</h3>
...
export default ScenarioSpecificInfo5;
