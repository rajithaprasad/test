...
interface ScenarioSpecificInfo0Props {
  formData: FormData;
...
const ScenarioSpecificInfo0 = ({ formData, updateFormData, onNext, onPrevious }: ScenarioSpecificInfo0Props) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-8 animate-fade-in">
      ...
      <div className="text-center">
        ...
        <p className="text-lg text-gray-600">Section 0</p>
      </div>

      <div className="bg-blue-50 rounded-xl p-6 border border-blue-100">
        <h3 className="text-xl font-semibold text-blue-800 mb-6">Section 0</h3>
...
export default ScenarioSpecificInfo0;
