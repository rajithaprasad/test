...
interface GuarantorInfoSection9Props {
  formData: FormData;
...
const GuarantorInfoSection9 = ({
  formData,
  updateFormData,
  onNext,
  onPrevious,
}: GuarantorInfoSection9Props) => {
    ...
    <form onSubmit={handleSubmit} className="space-y-8 animate-fade-in">
      ...
      <div className="text-center">
        ...
        <p className="text-lg text-gray-600">
          Section 9: Bridge Loan - Refinance
        </p>
      </div>

      <div className="bg-gray-50 rounded-xl p-6 border border-gray-200">
        <h3 className="text-xl font-semibold text-gray-800 mb-6">
          Guarantor Details - Section 9
        </h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="floating-input relative">
            <input
              ...
              onChange={(e) =>
                updateFormData({ creditScore: parseInt(e.target.value) || 0 })
              }
              placeholder=" "
              required
              className="w-full p-4 border-2 border-gray-200 rounded-xl bg-white/50 backdrop-blur-sm focus:border-emerald-500 focus:bg-white focus:outline-none transition-all duration-300 text-lg"
          ...
          <div className="floating-input relative">
            <input
              ...
              onChange={(e) =>
                updateFormData({ netWorth: parseInt(e.target.value) || 0 })
              }
              placeholder=" "
              required
              className="w-full p-4 border-2 border-gray-200 rounded-xl bg-white/50 backdrop-blur-sm focus:border-emerald-500 focus:bg-white focus:outline-none transition-all duration-300 text-lg"
          ...
          <div className="floating-input relative">
            <input
              ...
              onChange={(e) =>
                updateFormData({ liquidity: parseInt(e.target.value) || 0 })
              }
              placeholder=" "
              required
              className="w-full p-4 border-2 border-gray-200 rounded-xl bg-white/50 backdrop-blur-sm focus:border-emerald-500 focus:bg-white focus:outline-none transition-all duration-300 text-lg"
          ...
          <div className="floating-input relative">
            ...
            >
              ...
              <option value="Non-Permanent Resident">
...
export default GuarantorInfoSection9;
