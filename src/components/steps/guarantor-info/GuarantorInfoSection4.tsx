...
interface GuarantorInfoSection4Props {
  formData: FormData;
...
const GuarantorInfoSection4 = ({ formData, updateFormData, onNext, onPrevious }: GuarantorInfoSection4Props) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-8 animate-fade-in">
      ...
      <div className="text-center">
        <h2 className="text-3xl font-bold bg-gradient-to-r from-indigo-900 to-indigo-600 bg-clip-text text-transparent mb-3">
          Guarantor Information
        </h2>
        <p className="text-lg text-indigo-600">Section 4: Renovation Loan - Acquisition</p>
      </div>

      <div className="bg-indigo-50 rounded-xl p-6 border border-indigo-100">
        <h3 className="text-xl font-semibold text-indigo-800 mb-6">Guarantor Details - Section 4</h3>
...
export default GuarantorInfoSection4;
