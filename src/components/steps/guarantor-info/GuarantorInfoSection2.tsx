...
interface GuarantorInfoSection2Props {
  formData: FormData;
...
const GuarantorInfoSection2 = ({ formData, updateFormData, onNext, onPrevious }: GuarantorInfoSection2Props) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-8 animate-fade-in">
      ...
      <div className="text-center">
        <h2 className="text-3xl font-bold bg-gradient-to-r from-purple-900 to-purple-600 bg-clip-text text-transparent mb-3">
          Guarantor Information
        </h2>
        <p className="text-lg text-purple-600">Section 2: DSCR - Acquisition - STR</p>
      </div>

      <div className="bg-purple-50 rounded-xl p-6 border border-purple-100">
        <h3 className="text-xl font-semibold text-purple-800 mb-6">Guarantor Details - Section 2</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="floating-input relative">
            <input
              type="number"
              id="day30Lates"
              value={formData.day30Lates || ''}
              onChange={(e) => updateFormData({ day30Lates: parseInt(e.target.value) || 0 })}
              placeholder=" "
              className="w-full p-4 border-2 border-gray-200 rounded-xl bg-white/50 backdrop-blur-sm focus:border-emerald-500 focus:bg-white focus:outline-none transition-all duration-300 text-lg"
            />
            <label htmlFor="day30Lates" className="absolute left-4 top-4 text-gray-500 transition-all duration-300 pointer-events-none bg-white px-1 -mt-2 text-sm">
              30 day Lates
            </label>
          </div>
          ...
          <div className="floating-input relative">
            <input
              type="number"
              id="day60Lates"
              value={formData.day60Lates || ''}
              onChange={(e) => updateFormData({ day60Lates: parseInt(e.target.value) || 0 })}
              placeholder=" "
              className="w-full p-4 border-2 border-gray-200 rounded-xl bg-white/50 backdrop-blur-sm focus:border-emerald-500 focus:bg-white focus:outline-none transition-all duration-300 text-lg"
            />
            <label htmlFor="day60Lates" className="absolute left-4 top-4 text-gray-500 transition-all duration-300 pointer-events-none bg-white px-1 -mt-2 text-sm">
              60 day Lates
            </label>
          </div>
          ...
          <div className="floating-input relative">
            <input
              type="number"
              id="day90Lates"
              value={formData.day90Lates || ''}
              onChange={(e) => updateFormData({ day90Lates: parseInt(e.target.value) || 0 })}
              placeholder=" "
              className="w-full p-4 border-2 border-gray-200 rounded-xl bg-white/50 backdrop-blur-sm focus:border-emerald-500 focus:bg-white focus:outline-none transition-all duration-300 text-lg"
            />
            <label htmlFor="day90Lates" className="absolute left-4 top-4 text-gray-500 transition-all duration-300 pointer-events-none bg-white px-1 -mt-2 text-sm">
              90 day Lates
            </label>
          </div>
          ...
          <div className="floating-input relative">
            <input
              type="number"
              id="totalSTRs"
              value={formData.totalSTRs || ''}
              onChange={(e) => updateFormData({ totalSTRs: parseInt(e.target.value) || 0 })}
              placeholder=" "
              required
              className="w-full p-4 border-2 border-gray-200 rounded-xl bg-white/50 backdrop-blur-sm focus:border-emerald-500 focus:bg-white focus:outline-none transition-all duration-300 text-lg"
            />
            <label htmlFor="totalSTRs" className="absolute left-4 top-4 text-gray-500 transition-all duration-300 pointer-events-none bg-white px-1 -mt-2 text-sm">
              Total STRs
            </label>
          </div>
          ...
          <div className="floating-input relative">
            <input
              type="number"
              id="sameMarketSTRs"
              value={formData.sameMarketSTRs || ''}
              onChange={(e) => updateFormData({ sameMarketSTRs: parseInt(e.target.value) || 0 })}
              placeholder=" "
              required
              className="w-full p-4 border-2 border-gray-200 rounded-xl bg-white/50 backdrop-blur-sm focus:border-emerald-500 focus:bg-white focus:outline-none transition-all duration-300 text-lg"
            />
            <label htmlFor="sameMarketSTRs" className="absolute left-4 top-4 text-gray-500 transition-all duration-300 pointer-events-none bg-white px-1 -mt-2 text-sm">
              Same Market STRs
            </label>
          </div>
...
export default GuarantorInfoSection2;
