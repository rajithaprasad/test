...
interface GuarantorInfoSection5Props {
  formData: FormData;
...
const GuarantorInfoSection5 = ({ formData, updateFormData, onNext, onPrevious }: GuarantorInfoSection5Props) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-8 animate-fade-in">
      ...
      <div className="text-center">
        <h2 className="text-3xl font-bold bg-gradient-to-r from-pink-900 to-pink-600 bg-clip-text text-transparent mb-3">
          Guarantor Information
        </h2>
        <p className="text-lg text-pink-600">Section 5: Renovation Loan - Refinance</p>
      </div>

      <div className="bg-pink-50 rounded-xl p-6 border border-pink-100">
        <h3 className="text-xl font-semibold text-pink-800 mb-6">Guarantor Details - Section 5</h3>
...
export default GuarantorInfoSection5;
