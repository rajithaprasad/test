...
interface GuarantorInfoSection7Props {
  formData: FormData;
...
const GuarantorInfoSection7 = ({ formData, updateFormData, onNext, onPrevious }: GuarantorInfoSection7Props) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-8 animate-fade-in">
      ...
      <div className="text-center">
        <h2 className="text-3xl font-bold bg-gradient-to-r from-orange-900 to-orange-600 bg-clip-text text-transparent mb-3">
          Guarantor Information
        </h2>
        <p className="text-lg text-orange-600">Section 7: Construction Loan - Refinance</p>
      </div>

      <div className="bg-orange-50 rounded-xl p-6 border border-orange-100">
        <h3 className="text-xl font-semibold text-orange-800 mb-6">Guarantor Details - Section 7</h3>
...
export default GuarantorInfoSection7;
