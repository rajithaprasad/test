...
interface GuarantorInfoSection3Props {
  formData: FormData;
...
const GuarantorInfoSection3 = ({ formData, updateFormData, onNext, onPrevious }: GuarantorInfoSection3Props) => {
    ...
    <form onSubmit={handleSubmit} className="space-y-8 animate-fade-in">
     <ProgressIndicator
      ...
      <div className="text-center">
        <h2 className="text-3xl font-bold bg-gradient-to-r from-yellow-900 to-yellow-600 bg-clip-text text-transparent mb-3">
          Guarantor Information
        </h2>
        <p className="text-lg text-yellow-600">Section 3: DSCR - Refinance - STR</p>
      </div>

      <div className="bg-yellow-50 rounded-xl p-6 border border-yellow-100">
        <h3 className="text-xl font-semibold text-yellow-800 mb-6">Guarantor Details - Section 3</h3>
...
export default GuarantorInfoSection3;
