...
interface GuarantorInfoSection0Props {
  formData: FormData;
...
const GuarantorInfoSection0 = ({ formData, updateFormData, onNext, onPrevious }: GuarantorInfoSection0Props) => {
  const userType = localStorage.getItem('userType');
  const showBorrowerFields = userType === 'borrower';
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-8 animate-fade-in">
      ...
      <div className="bg-blue-50 rounded-xl p-6 border border-blue-100">
        <h3 className="text-xl font-semibold text-blue-800 mb-6">Guarantor Details - Section 0</h3>
...
export default GuarantorInfoSection0;
